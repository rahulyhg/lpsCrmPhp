...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
         ...
         */
        public function __construct($orientation = 'P', $format = 'A4', $langue='fr', $unicode=true, $encoding='UTF-8', $marges = array(1, 1, 1, 1))
        {
...
<html>
    ...
    <body style="padding: 10px; font-size: 10px;font-family:    Georgia, "Times New Roman", Times, serif;">
'.$content.'
    </body>
</html>';
            exit;
