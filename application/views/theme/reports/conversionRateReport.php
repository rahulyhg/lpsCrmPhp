...
$rows = [
    "sent" => "Total Sent",
    "paymentAdded" => "Payments Added",
    "conversion" => "Conversion Percentage",
    "Refund" => "Refunds",
    "StopPayment" => "Stop Payment",
    "ChargeBack" => "ChargeBacks",
    "returnRate" => "Return Rate percentage"
];
$day = date('w') - 1;
            ...
            foreach ($rows as $key => $row) {
                ...
                if ($key === "conversion") {
                    ...
                    <tr>
                        ...
                        <?php
                        foreach ($states as $short => $state) {
                            $total += $reports["sent"][$short] ? number_format($reports["paymentAdded"][$short] / $reports["sent"][$short], 2) : 0;
                            ?>
                            <td><?= $reports["sent"][$short] ? number_format($reports["paymentAdded"][$short] / $reports["sent"][$short], 2) : 0 ?></td>
                            <?php
                        }
//                        $totalPayment = $total;
                        ?>
                    ...
                    <?php
                } elseif ($key === "returnRate") {
                    ?>
                    <tr>
                        <th><?= $row ?></th>
                        <?php
                        foreach ($states as $short => $state) {
                            $total += $totalPayment ? number_format(($reports["ChargeBack"][$short] + $reports["Refund"][$short] + $reports["StopPayment"][$short]) / $totalPayment, 2) : 0;
                            ?>
                            <td><?= $totalPayment ? number_format(($reports["ChargeBack"][$short] + $reports["Refund"][$short] + $reports["StopPayment"][$short]) / $totalPayment, 2) : 0 ?></td><?php
                        }
                        ?>
                        <th><?= $total ?></th>
                    </tr>
