...
<div id="content-nav-right">
    <div class="btn-group float-md-right" role="group">
        ...
        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" x-placement="bottom-start">
            <a class="dropdown-item" href="<?= jobs_url("activeJobs") ?>">Active Jobs</a>
        </div>        
...
<script>
    ...
    function getTableData() {
        ...
        Table = $('.serverSide-table').DataTable({
            ...
            'aoColumns': [{mData: "date"}, {mData: "completionDate"}, {mData: "job"}, {mData: "count"},
            ...
            'bServerSide': true,
            'sAjaxSource': '<?= jobs_url("getfinishedJobs") ?>',
