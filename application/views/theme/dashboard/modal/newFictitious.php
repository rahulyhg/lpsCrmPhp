...
?><div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="newEventMoalLebel"></strong> Import Fictitious</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body">                                      
            <form method="post" enctype="multipart/form-data" action="<?= dashboard_url("newFictitious") ?>" class="container green lighten-3 rounded-left p-1">
                <div class="row">                    
                    <div class="col-12">
                        <div class="form-group">
                            <label class="h6">Chose <strong>Fictitious</strong> data Excel File </label>
                            <input type="file" name="file" required class="form-control-file"  accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                        </div>
                    </div>
                    <?php
                    $dbColumns = ['fname' => "regDate", 'mname' => "county", 'lname' => "owner",
