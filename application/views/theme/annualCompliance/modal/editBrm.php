...
?><div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="newEventMoalLebel">Edit BRM</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body">
            <form method="post" id="newPaymentForm" novalidate action="<?= dashboard_url("editBrm/" . $brm["id"]) ?>" class="container-fluid" 
                  enctype="multipart/form-data" >
                <div class="row">
                    <div class="col-12">
                        <fieldset class="form-group">
                            <label>Date</label>
                            <input type="text" name="date" class="form-control slelctedDate " required="" value="<?= changeDateFormat($brm["date"], "d M, Y") ?>">
                            <input type="hidden" name="id" value="<?= $brm["id"] ?>">
...
<!--                                <input value="0" placeholder="sent" class="form-control square form-control-sm mx-1 " id="sent" readonly/>-->
                    ...
                    <div class="col-12 text-center py-1">
                        <button type="submit" class="btn bg-blue-grey square" value="newBrm">Edit</button>
                    </div>
                </div>
            </form>            
        </div>
