...
<div id="content-nav-right">
    <div class="btn-group float-md-right" role="group">
        <div class="btn-group" role="group">
            ...
            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" x-placement="bottom-start">
                ...
                if (hasPermission("deposits/add")) {
                    ...
                    <a class="dropdown-item" href="<?= deposits_url("banks") ?>">Banks Dashboard</a>
                    <?php
                }
                ?>
            </div>
        ...
        <a class="btn btn-outline-blue-grey"  modal-toggler="true" data-target="#remoteModal1" data-remote="<?= deposits_url("newBank") ?>">New Bank</a>
    </div>
</div>
<style>
</style>
...
<script>
    ...
    function geTableData() {
        Table = $('.serverSide-table').DataTable({
            ...
            'aoColumns': [{mData: "company"}, {mData: "dba"}, {mData: "bankName"},
                {mData: "account"}, {mData: "state"}, {mData: "actions"}],
            ...
            'bServerSide': true,
            'sAjaxSource': '<?= deposits_url("getBankList") ?>',
