...
foreach (array_keys(getProDocStateColumnsShow($_currentState)) as $col) {
        ...
        <div class="btn-group" role="group">
            ...
            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" x-placement="bottom-start">
                ...
                if (hasPermission("proDoc/orders")) {
                    ?>
                    <a class="dropdown-item" href="<?= proDoc_url("orders/" . $_currentState) ?>">Orders</a>
                    <?php
                }
    ...
    <table class="table table-striped table-bordered serverSide-table dtr-inline w-100" style="width: 100%">
        <thead class="w-100">
            <tr>  
                ...
                <th>ShippedDate<br></th>
                <th>PaymentDate<br></th>
                <th>#<br>
...
<?php } ?>
            ...
            text: "Back to Order",
                    ...
                    open("<?= proDoc_url("makeOrderFromShiped/" . $_currentState) ?>?customers=" + shippeds, "_self");
                    }
                    });
                    } else {
            ...
            'aoColumns': [{mData: "shippedDate"}, {mData: "orderDate"}, {mData: "id", bSortable: false},
            {mData: "paymentType"},
            {mData: "contactID"}, {mData: "company"}, {mData: "siteAddress"}, {mData: "price"}, {mData: "email"},
            {mData: "phone"}, {mData: "actions", bSortable: false}],
            ...
            'bServerSide': true,
            'sAjaxSource': '<?= proDoc_url("getCustomersData/" . $_currentState) ?>',
    ...
    {column_number: 3, filter_default_label: "select", data: ["Check", "Credit", "Online"], filter_type: "select", filter_reset_button_text: "<i class='fa fa-close'></i>"},
