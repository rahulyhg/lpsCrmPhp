...
<div id="content-nav-right">
    <div class="btn-group float-md-right" role="group">
        ...
        <?php if (hasPermission("proDoc/add")) { ?>
        ...
        <?php } ?>        
        <?php if (hasPermission("proDoc/orderAdd")) { ?>
...
<table class="table table-striped table-bordered table-responsive serverSide-table dtr-inline w-100 table-hover">
    <thead class="w-100">
        <tr>            
            <?php
            $loadColumns = [];
            foreach (getProDocStateColumnsShow($_currentState) as $column => $show) {
...
<?php } ?>
            ...
            'bServerSide': true,
            'sAjaxSource': '<?= proDoc_url("getProspectsData/" . $_currentState) ?>',
...
<?php for ($n = 2; $n < sizeof(getProDocStateColumns($_currentState)); $n++) { ?>
