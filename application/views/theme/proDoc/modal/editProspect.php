...
?><div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" id="newForm" novalidate action="<?= proDoc_url("editProspect/" . $prospect->id) ?>" class="container" 
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <fieldset class="form-group">
                            <strong>Pre Sort Date</strong>
                            <input type="text" name="saleDate" class="form-control slelctedDate " required="" value="<?= changeDateFormat($prospect->saleDate, "d M, Y") ?>">

                            <p class="help-block m-0 danger"></p>
                        </fieldset>
                    </div>
                    <?php
                    $columns = getProDocStateColumnsShow($prospect->stateID);
                    foreach ($columns as $column => $showName) {
                        if ($column !== "preSortDate" && $column !== "saleDate") {
                            ?>
                            <div class="col-12">
                                <fieldset class="form-group">
